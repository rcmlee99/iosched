...
public class Config {
    ...
    public static final String PROD_CONFERENCE_DATA_MANIFEST_URL = "http://my-mobile-demos.s3.amazonaws.com/manifest.json";
    ...
    // YouTube API config
    public static final String YOUTUBE_API_KEY = "AIzaSyCNv4Z2aA_HQHA5UEg69kBRWPLAChHfaSs";
